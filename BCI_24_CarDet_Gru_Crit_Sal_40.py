...
# MAGIC ### Encabezado
# MAGIC **************************************************************************
# MAGIC * Nombre: BCI_24_CarDet_Gru_Crit_Sal_40.ipynb
# MAGIC * Ruta: 
# MAGIC * Autor: Gabriel Martinez (SimpleData) - Ing. SW BCI: Jonatan Cancino
# MAGIC * Fecha: 09/09/2022
# MAGIC * Descripcion: Salida de SSFF.
...
# MAGIC %md
# MAGIC ### (40) Operacion no viene en el archivo SSFF
...
# MAGIC %sql
# MAGIC 
# MAGIC --select count(1) from riesgobdu_silver_db.tbl_cartdet_crit_sal_ope_campo where criterio_salida = 40 and flag_resultado_regla = 1
# MAGIC 
