...
# MAGIC ### Encabezado
# MAGIC **************************************************************************
# MAGIC * Nombre: BCI_03_CarDet_Ind_Crit_Sal_3.ipynb
# MAGIC * Ruta: 
# MAGIC * Autor: Gabriel Martinez (SimpleData) - Ing. SW BCI: Jonatan Cancino
# MAGIC * Fecha: 18/08/2022
# MAGIC * Descripcion: Clientes informado sin Calificacion de riesgo. Criterio 3.
...
# MAGIC %md
# MAGIC ### Clientes sin Calificacion Bci informado (tbl_segmentacion_cliente_consolidado)
# MAGIC --------------------------------------
# MAGIC - Se extrae clientes para el periodo actual con la clasificacion bci desde la tabla tbl_segmentacion_cliente_consolidado 

# COMMAND ----------

#Extrae clientes SIN clasificacion bci 
...
'calificacion_bci' AS nombre_campo,
 ...
 " = "  AS condicion_regla,     
 " ' ' "  AS valor_regla,
 CASE WHEN trim (B.calificacion_bci) = ' ' THEN 1 ELSE 0 END AS flag_resultado_regla
FROM 
...
paso_query70 = f"""DELETE FROM {base_silverX}.tbl_cartdet_crit_sal_ope_crit where fecha_cierre = {FechaX} AND criterio_entrada = 3 """
...
paso_query100 = f"""DELETE FROM {base_silverX}.tbl_cartdet_crit_sal_ope_campo where fecha_cierre = {FechaX} AND criterio_entrada = 3"""
