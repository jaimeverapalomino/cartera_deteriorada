...
# MAGIC %md
# MAGIC # Notebook: Criterios de Salida Deterioro Segmento Individual Por Operacion
# MAGIC *********************************************************************************
...
# MAGIC ### Encabezado
# MAGIC **************************************************************************
# MAGIC * Nombre: BCI_05_CarDet_Ind_Crit_Sal_Crit.ipynb
# MAGIC * Ruta: 
# MAGIC * Autor: Gabriel Martinez (SimpleData) - Ing. SW BCI: Jonatan Cancino
# MAGIC * Fecha: 17/08/2022
# MAGIC * Descripcion: Carga Todos los creteririos de salida que cumple una operacion individual
...
# MAGIC --------------------------------------
# MAGIC - Genera salida temporal con todos los criterios de deterioro que cumple una operacion
...
# MAGIC %md
# MAGIC ### Carga Tabla Evaluacion por Criterio (riesgobdu_silver_db.tbl_cartdet_crit_sal_ope_crit)
...
paso_query300 = f"""DELETE FROM {base_silverX}.tbl_cartdet_crit_sal_ope_crit where fecha_cierre = {FechaX} AND periodo_cierre = {PeriodoX} and tipo_proceso = '{tipo_procesoX}' and criterio_salida  IN {p_IndCritDetSal} """
...
# MAGIC %sql
# MAGIC SELECT periodo_cierre, fecha_cierre, tipo_proceso, criterio_salida, count(*) FROM riesgobdu_silver_db.tbl_cartdet_crit_sal_ope_crit group by 1,2,3,4

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from riesgobdu_silver_db.tbl_cartdet_crit_sal_ope_crit where rut_cliente=7776581
