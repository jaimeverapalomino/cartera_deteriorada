...
# MAGIC %md
# MAGIC # Notebook: Cuadratura Deterioro, Segmento Individual.
# MAGIC *********************************************************************************
...
# MAGIC ### Encabezado
# MAGIC **************************************************************************
# MAGIC * Nombre: BCI_02_CarDet_Cuadratura_Individual.ipynb
# MAGIC * Ruta: 
...
# MAGIC %md
# MAGIC ### Extrae Stock Deterioro Individual Proceso Nuevo (tbl_cartdet_individual_stock)
# MAGIC ---
# MAGIC * Tabla con stock de deterioro individual calculado con nuevo proceso 

# COMMAND ----------

paso_query10 = f"""
CREATE OR REPLACE TEMPORARY VIEW  tmp_EXT_tbl_cartdet_individual_stock_new AS 
SELECT
...
FROM
  {base_silverX}.tbl_cartdet_individual_stock A
WHERE
    fecha_cierre = {FechaX}  
...
# MAGIC %sql
# MAGIC --select * from tmp_EXT_tbl_cartdet_individual_stock_new

# COMMAND ----------

# MAGIC %md
# MAGIC ### Extrae Stock Deterioro Individual Proceso Productivo (tbl_segmentacion_d00_segmentado)
# MAGIC ---
# MAGIC * Tabla con stock de deterioro individual calculado con proceso productivo 
...
AND IFNULL(cast(cod_motivo_cartdet as integer),0)  IN ({p_IndCritDetEnt})  
and ind_cartdet='D'
""" 
...
# MAGIC %sql
# MAGIC --select * from riesgobdu_golden_db.tbl_segmentacion_d00_segmentado where rut_cliente=76024083
# MAGIC 
# MAGIC --select * from tmp_EXT_tbl_cartdet_individual_stock_prd where rut_cliente=76024083
# MAGIC 
# MAGIC --select * from tmp_EXT_tbl_cartdet_individual_stock_new where rut_cliente=76024083
# MAGIC 
# MAGIC select * from tmp_EXT_tbl_cartdet_individual_stock_prd 
...
# MAGIC 
# MAGIC select * from tmp_RES_cartdet_individual_universo 
