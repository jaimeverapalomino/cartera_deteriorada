...
# MAGIC ### Encabezado
# MAGIC **************************************************************************
# MAGIC * Nombre: BCI_08_CarDet_Gru_Crit_Ent_8.ipynb
# MAGIC * Ruta: 
# MAGIC * Autor: Gabriel Martinez (SimpleData) - Ing. SW BCI: Jonatan Cancino
# MAGIC * Fecha: 26/08/2022
# MAGIC * Descripcion: Cliente con Crédito hipotecario de la vivienda  o con crédito para financiamiento de estudio superiores CAE en cartera vencida. Criterio 8.
...
WHERE 
  ...
  and trim(b.cod_sistema) = '03' and trim(b.tipo_credito) = '05'
  or trim(b.tipo_operacion) like 'CAE%'
"""
...
SELECT
 ...
 A.dv_cliente                         AS dv_cliente,
 A.tipo_operacion                     AS tipo_operacion,
 A.fec_cart_ven                       AS fec_cart_ven,
...
paso_query160 = f"""DELETE FROM {base_silverX}.tbl_cartdet_crit_ent_ope_campo where fecha_cierre = {FechaX} AND criterio_entrada = {p_GruCritDetEnt} AND tipo_proceso = '{tipo_procesoX}' """
